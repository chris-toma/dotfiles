...
# Function to check and start RabbitMQ
check_rabbitmq() {
...
# Function to check if tmuxp is installed
check_tmuxp() {
...
# Function to check if the project directory exists
check_project_directory() {
    echo "🔍 Checking project directory..."
    if [ ! -d "/Users/christoma/projects/captiv8/go-microservices" ]; then
        echo "❌ Project directory not found: /Users/christoma/projects/captiv8/go-microservices"
...
# Function to check if fut script exists and is executable
check_fut_script() {
    echo "🔍 Checking fut script..."
    if [ ! -f "/Users/christoma/projects/captiv8/go-microservices/fut" ]; then
        echo "❌ fut script not found in project directory."
        echo "Please ensure the fut script exists and is executable."
        exit 1
    fi
    if [ ! -x "/Users/christoma/projects/captiv8/go-microservices/fut" ]; then
        echo "🔧 Making fut script executable..."
        chmod +x /Users/christoma/projects/captiv8/go-microservices/fut
    fi
...
main() {
    ...
    # Start the master configuration
    echo "🚀 Loading master tmuxp configuration..."
    tmuxp load /Users/christoma/.tmuxp/master.yaml
